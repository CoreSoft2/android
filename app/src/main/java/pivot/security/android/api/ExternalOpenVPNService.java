...
import pivot.security.android.activities.ConfirmAPIActivity;
import pivot.security.android.activities.GrantPermissionsActivity;
    ...
    private final IOpenVPNAPIService.Stub mBinder = new IOpenVPNAPIService.Stub() {
        ...
        private void startProfile(VpnProfile vp) {
            ...
            if (vpnPermissionIntent != null || needpw != 0) {
                ...
                shortVPNIntent.setClass(getBaseContext(), pivot.security.android.LaunchVPN.class);
                shortVPNIntent.putExtra(pivot.security.android.LaunchVPN.EXTRA_KEY, vp.getUUIDString());
                shortVPNIntent.putExtra(pivot.security.android.LaunchVPN.EXTRA_HIDELOG, true);
